...
class TestCoherence(unittest.TestCase):
    ...
    def test_invalid_target_band(self):
        ...
        with self.assertRaises(pydantic.ValidationError):
            coherence_agent(InputState(**self.input_data))
    ...
    def test_valid_output_format(self):
        out = coherence_agent(InputState(**self.input_data))
    ...
    def test_word_count(self):
        ...
        out = coherence_agent(InputState(**self.input_data))
        self.assertLessEqual(out['coherence_score'],1,f"Band score of {out['coherence_score']} exceeds 1 when word count not reached")
